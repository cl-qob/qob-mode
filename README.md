...
[![JCS-ELPA](https://raw.githubusercontent.com/jcs-emacs/badges/master/elpa/v/qob-mode.svg)](https://jcs-emacs.github.io/jcs-elpa/#/qob-mode)
...
with other `.lisp` source files.

Just open the Qob file, or `M-x qob-mode` should start the major mode explicitly
